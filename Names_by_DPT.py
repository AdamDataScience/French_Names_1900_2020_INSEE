...
grid = AgGrid(name_data.head(search_number), grid_options=gob.build(), editable=False, theme='streamlit', fit_columns_on_grid_load=True,fit_rows_on_grid_load=True)
# grid_selected_row = grid['selected_rows']
grid_selected_row = grid.get_selected_rows()
