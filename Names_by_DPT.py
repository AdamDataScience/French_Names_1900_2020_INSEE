...
grid = AgGrid(name_data.head(search_number), grid_options=gob.build(), allow_unsafe_jscode=True, update_mode=GridUpdateMode.SELECTION_CHANGED, editable=True, theme='streamlit', fit_columns_on_grid_load=True)
